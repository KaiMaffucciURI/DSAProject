...
LLRBTNode* LLRBTree::search(const std::string& word, LLRBTNode* root){
...
int LLRBTree::search(const std::string& word){ //Calls the other search function
    LLRBTNode* foundnode = search(to_lower(word), this->_root);
